...
head:
  image: '/images/raids/sepulcher/jailer-icon.png'
  link:
...
The fight starts with us pulling the boss off to the side from where he starts.

1. `0:15` — [Torment #1](https://www.wowhead.com/spell=362415/torment) spread.
2. `0:18` — [Chains #1](https://www.wowhead.com/spell=362631/chains-of-oppression). Gateway to :marker{icon="Circle"}
